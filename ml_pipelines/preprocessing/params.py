...
class PreprocessingParams:
    def __init__(self):
        ...
        self.input_flights_table = os.path.join(
            base_path, "test_data/data/raw/flights_sample_3m.csv"
        )
        self.input_airport_table = os.path.join(
            base_path, "test_data/data/raw/airports.csv"
        )
        self.cache_dir = os.path.join(base_path, "test_data/weather_cache")
