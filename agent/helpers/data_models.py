...
class FinalPrediction(RouteValidators):
    ...
    origin: str = Field(..., description="Departure airport IATA code")
    destination: str = Field(..., description="Arrival airport IATA code")
    distance: float = Field(..., description="Distance between origin and destination in miles")
    ...
    is_bank_holiday: BinaryFlag = Field(..., description="1 if the flight date is a bank holiday, else 0")
